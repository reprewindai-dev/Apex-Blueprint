                        ...
                        <div className="p-3 bg-[#050505] border border-[#222] space-y-2 text-[9.5px]">
                          ...
                          <div className="space-y-1.5">
                            <div>
                              ...
                              <span className="text-gray-200 normal-case block leading-relaxed">{cap.jurisdictionPolicy.dataBoundaryProfile}</span>
                            </div>
                            <div>
                              <span className="text-gray-500">Sovereign Constraints applied:</span>
                              <span className="text-[#00F0FF] block mt-0.5 font-bold">{cap.jurisdictionPolicy.jurisdictionConstraints.join(", ")}</span>
                            </div>
                            <div>
                              <span className="text-gray-500">Legal Audit Profile:</span>
                              <span className="text-gray-300 normal-case block leading-relaxed">{cap.jurisdictionPolicy.auditRetentionProfile}</span>
                            </div>
                          </div>
                        </div>
                    ...
                    {activeSubTab === "verification" && (
                      <div className="space-y-3.5 animate-fadeIn">
                        ...
                        <div className="p-3 bg-[#050505] border border-[#222] space-y-1.5 text-[9.5px]">
                          <span className="text-[9px] text-emerald-400 font-black block uppercase">[ EVIDENCE STANDARDS ]</span>
