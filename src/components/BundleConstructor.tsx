  ...
  const priceCalculation = useMemo(() => {
    ...
    capabilities.forEach(cap => {
      if (selectedCaps[cap.id]) {
        basePriceFloor += cap.pricingModel.priceFloor;
        selectedCount++;
      }
    });
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-[9px] text-[#444] leading-tight normal-case">{cap.pricingModel.billingUnit} — Floor: ${cap.pricingModel.priceFloor}</p>
                      </div>
                    </div>
                  );
                })}
